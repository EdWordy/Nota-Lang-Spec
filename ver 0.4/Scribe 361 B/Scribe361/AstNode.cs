namespace Scribe361
{
    ...
    public class AstForStatement : AstNode
    {
        public AstNode TypeKeyword { get; }
        public AstNode Identifier { get; }
        public AstNode FromKeyword { get; }
        public AstNode LowerIndex { get; }
        public AstNode ToKeyword { get; }
        public AstNode UpperIndex { get; }

        public AstBlock StatementBody { get; }

        public AstForStatement(AstNode typeKeyword, AstNode fromKeyword, AstNode identifier, AstNode lowerIndex, AstNode toKeyword, AstNode upperIndex, AstBlock statementBody)
        {
